      ...
      <Container maxWidth="xl">
        ...
        >
          ...
          >
            ...
            <Link href="https://venda.nextfit.com.br/9cb98add-dc2f-4a98-a316-344b955a1c05/contratos">
              <Button
                variant="contained"
                color="error"
                sx={{
          ...
          <IconButton
            ...
            aria-haspopup="true"
            onClick={(event) => setAnchorElNav(event.currentTarget)} // Atualize esta linha
            color="inherit"
